...
public class App2 {
    ...
    private JLabel lbBlankFontYouScore;
    ...
    private void detailComponents(){
        ...
        lbBlankFontYouScore = new JLabel("  ");
        lbYourclicks = new JLabel("Your Turn");
        lbclicks = new JLabel("10");

        
        lbLogo.setPreferredSize(new Dimension(225, 70));
