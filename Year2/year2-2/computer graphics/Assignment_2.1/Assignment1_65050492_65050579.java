...
public class Assignment1_65050492_65050579 extends JPanel {
    private long snowFallTime; // เวลาที่หิมะเริ่มตก
    private long currentTime; // เวลาปัจจุบัน
    private Timer timer;
    ...
    public Assignment1_65050492_65050579() {
        timer = new Timer(2000, e -> drawOlafAndRepaint(null, null));
    }

    private void drawOlafAndRepaint(Graphics2D g2d, BufferedImage buffer) {
        drawOlaf(g2d, buffer);
        repaint();
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        currentTime = System.currentTimeMillis(); // รับค่าเวลาปัจจุบัน
    ...
    private void drawSnow(Graphics2D g2d) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            midpointCircle(g2d, x, y, 1, size);
        }
    }

    private void startSnowFall() {
        snowFallTime = System.currentTimeMillis();
    ...
    private void saveImage() {
        ...
        try {
            ImageIO.write(imageBuffer, "gif", new File("Assignment1_65050492_65050579.png"));
